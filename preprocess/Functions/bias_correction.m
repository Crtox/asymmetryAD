function output_file = bias_correction(input_file, options);
...
%change of script- Eva Rebec, 6.5.2022 to segment:
%  -matlabbatch{1}.spm.spatial.preproc.channel.biasreg: from 0 to 0.001
%  -matlabbatch{1}.spm.spatial.preproc.channel.write = [0 1] - it writes
%  out m-file which is bias corrected
...
file_list = dir(temp_path)   %selection of this m file as our output
filenames = {file_list.name};
file_indexes = strfind(filenames,'m');
